...
const { getNewProduct, getFeaturedProduct, getProductForListing, getProductById } = require("../handlers/products-handler");
...
router.get("/home/feartured-products", async (req, res) => {
